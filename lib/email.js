...
//        CONTACT_EMAIL   = your inbox for notifications (defaults to cleverdigitals70@gmail.com)
//
...
function ownerEmail() {
  return process.env.CONTACT_EMAIL || 'cleverdigitals70@gmail.com';
}
...
function shell(innerHtml) {
  return '<div style="' + brandStyle + 'max-width:560px;margin:0 auto;color:#1a1d2e;">' +
    ...
    'CleverStack — Lagos, Nigeria · <a href="https://cleverstack.dev" style="color:#4F46E5;">cleverstack.dev</a></p>' +
    '</div>';
}
